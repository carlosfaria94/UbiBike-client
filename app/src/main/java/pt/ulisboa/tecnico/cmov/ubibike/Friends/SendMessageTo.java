...
public class SendMessageTo extends AppCompatActivity {
    ...
    public void updateGUI()
    {
        ...
        final HashMap<String,String> friendsNearby = globalVariable.getFriends();
            ...
            listView.setOnItemClickListener(
                    new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent i = new Intent(SendMessageTo.this, ChatActivity.class);
                            i.putExtra("friendsIP", friendsNearby.get(listaFriends.get(position)));
        ...
        searchText.addTextChangedListener(
                new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        listView.setAdapter(new ArrayAdapter<String>(SendMessageTo.this, android.R.layout.simple_list_item_1, friends_sorted));
                    }
